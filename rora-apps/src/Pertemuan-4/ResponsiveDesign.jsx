export default function ResponsiveText() {
  return (
    <div>
      <p className="text-sm md:text-red-500 lg:text-blue-900 xl:text-2xl mb-4">
...
function ResponsiveLayout(){
    return (
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-5 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
                <div class="bg-green-500 p-4">Box 1</div>
                <div class="bg-blue-500 p-4">Box 2</div>
                <div class="bg-blue-500 p-4">Box 3</div>
                <div class="bg-red-500 p-4">Box 4</div>
